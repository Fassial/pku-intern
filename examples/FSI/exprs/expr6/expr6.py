"""
Created on 15:06, May. 24th, 2021
Author: fassial
Filename: expr6.py
Description:
    Changes in spatial patterning (Ω) as a function of topology (p_g) of the GJ network,
    for r_g = 3, 5, 10.
"""
import numpy as np
...
def main(dt = 0.01):
    ...
    r_gs = [3, 5, 10]
    p_gs = np.arange(0., 1.01, 0.05).astype(dtype = np.float32)
    g_gaps = [0.45, 0.21, 0.095]
