"""
Created on 15:19, Apr. 15th, 2021
Author: fassial
Filename: crc32c.py
"""
import array
...
## def helper func
# def _crc_update func
def _crc_update(crc, data):
...
# def _crc_finalize func
def _crc_finalize(crc):
...
def crc32c(data):
    ...
    """
    return _crc_finalize(_crc_update(_CRC_INIT, data))
